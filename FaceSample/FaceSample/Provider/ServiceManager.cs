        ...
        private static HttpClient Client
        {
            get
            {
                if (_client == null)
                {
                    ...
                    {
                        BaseAddress = new Uri("https://facedetecte.cognitiveservices.azure.com/face/v1.0/")
                    };
                    _client.DefaultRequestHeaders.Add("Accept", "application/json");
                    _client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", "dd8fd99439b549e2a5df493f95ad1777");
                }
                return _client;
            }
        }
